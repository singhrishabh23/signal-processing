...
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/Sound_Noise.wav
\end{lstlisting}
...
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/2.3_noise.py
\end{lstlisting}
...
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/3.1.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
	python3 3.1.py
...
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/3.2.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
	python3 3.2.py
...
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/3.3.c
wget https://github.com/singhrishabh23/signal-processing/blob/main/3.3_plot.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
	gcc 3.3.c -o 3.3.out
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{./figs/3_3_plot.png}
...
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/4.5.py
\end{lstlisting}
run the above code using the command 
\begin{lstlisting}
	python3 4.5.py
...
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/5.1.py
\end{lstlisting}
...
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/5.2.py
\end{lstlisting}
run the above code using the command.
\begin{lstlisting}
	python3 5.2.py
...
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/5.6.py
\end{lstlisting}
...
%
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/5.4.py
\end{lstlisting}
run the above code using the command.
\begin{lstlisting}
	python3 5.4.py
...
%
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/5.5.py
\end{lstlisting}
run the above code using the command.
\begin{lstlisting}
	python3 5.5.py
...
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/5.9.py
\end{lstlisting}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\columnwidth]{./figs/5_5_conv.png}
...
%
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/6.1.py
\end{lstlisting}
run the above code using the command.
\begin{lstlisting}
	python3 6.1.py
...
%
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/6.2.py
\end{lstlisting}
run the above code using the command.
\begin{lstlisting}
	python3 6.2.py
...
%
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/6.3.py
\end{lstlisting}
run the above code using the command.
\begin{lstlisting}
	python3 6.3.py
...
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/6.4.py
\end{lstlisting}
...
\solution Download the code from
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/6.6.py
\end{lstlisting}
and execute it using
\begin{lstlisting}
$ python3 6.6.py
...
\solution Download the code from
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/7.1.py
\end{lstlisting}
and execute it using
\begin{lstlisting}
$ python3 7.1.py
...
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/7.2.1.py
\end{lstlisting}
The filter frequency response is plotted at
\begin{lstlisting}
	wget https://github.com/singhrishabh23/signal-processing/blob/main/7.2.2.py
\end{lstlisting}
...
\begin{lstlisting}
wget https://github.com/singhrishabh23/signal-processing/blob/main/7.2.3.py
\end{lstlisting}
