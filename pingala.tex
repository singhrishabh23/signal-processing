...
\begin{document}
	...
	\begin{enumerate}[label=\thesection.\arabic*,ref=\thesection.\theenumi]
		...
		\end{lstlisting}
		\begin{figure}[!htp]
			\includegraphics[width=\columnwidth]{/home/rishabh/Desktop/pingala/figs/2_2.png}
			\caption{Plot of $x(n)$}
			\label{fig:xn}
		\end{figure}
		...
		\end{lstlisting}
		\begin{figure}[!htbp]
			\includegraphics[width=\columnwidth]{/home/rishabh/Desktop/pingala/figs/2_1.png}
			\caption{Plot of $y(n)$}
			\label{fig:yn}
		\end{figure}
		\item Find $Y^{+}(z)$. 
